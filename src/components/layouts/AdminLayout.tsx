...
const AdminLayout = () => {
  ...
  const navigation = [
    ...
    { name: "Assessments", href: "/admin/assessments", icon: Tractor },
    { name: "Risk assessments", href: "/admin/risk-assessments", icon: Map },
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        <header className="h-16 border-b border-border bg-card/50 backdrop-blur-sm flex items-center justify-between px-6 shrink-0 md:hidden">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">Starhawk Admin</span>
          </div>
